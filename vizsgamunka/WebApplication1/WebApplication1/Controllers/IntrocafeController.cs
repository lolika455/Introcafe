...
namespace WebApplication1.Controllers
{
    ...
    public class IntrocafeController : ControllerBase
    {
        ...
        // Request model for updating Intropoints
        public class UpdateIntropointsRequest
        {
            public long Uid { get; set; } // User ID
            public long NewIntropoints { get; set; } // New Intropoints value
        }
